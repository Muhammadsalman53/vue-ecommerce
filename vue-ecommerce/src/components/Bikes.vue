      ...
      <div class="col-12" id="mble-products">
        <div class="container">
          <div class="col-12 pb-4" id="mob-head">
              <h3>More in Bikes & Motorcycle:</h3>
              <button class="btn btn-lg btn-outline-primary" type="button"><a href="#">View All ></a></button>
          </div>
          <div id="carouselBikeControls" class="carousel slide" data-bs-ride="carousel">
            ...
            <button class="carousel-control-prev" type="button" data-bs-target="#carouselBikeControls" data-bs-slide="prev">
              <span class="carousel-control-prev-icon" aria-hidden="true"></span>
              <span class="visually-hidden">Previous</span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#carouselBikeControls" data-bs-slide="next">
