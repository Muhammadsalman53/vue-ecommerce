<template>
    <main>
                ...
                <div class="cart-item" v-for="item in cartItems" :key="item.id">
                    <div class="item-details">
                        ...
                        <div class="form-outline" style="width: 4rem;">
                            ...
                            <input type="number" v-model="quantity" id="form1" class="form-control form-icon-trailing"/>
                        </div>
        ...
        <button class="btn btn-success" id="cart-buy-btn" @click="$router.push('/buynow')">Buy Now</button>
    </main>
</template>
